...
(function() {
  ...
  describe('duplicate references', function() {
    ...
    return it('should not have an __ksId', function() {
      return assert(!(decoded['__ksId'] != null));
    });
  });
  ...
  describe('arrays', function() {
    return it('should encode arrays properly', function() {
      ...
      assert(encoded[0]['__ksId'] != null);
      return assert(encoded[0]['__ksId'] === encoded[1]['__ksRef']);
    });
  });
